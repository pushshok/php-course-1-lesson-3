...
$Title = "Сайт компании Минималистика";
$h1 = "Минималистика";
...
$punkty = [home, archive, contact];
$menu = "<ul id='menu'>";

	foreach ($punkty as $slovo) {
		$menu .= "<li><a href='#'>$slovo</a></li>";
	}
...
?>
		...
		<div id="footer">
			<p>Copyright <?php echo date("Y"); ?> &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>